...
int main()
{
    ...
    bool is_laptop = filename.find("laptop") != std::string::npos ||
                     ...
                     filename.find("laptp") != std::string::npos;
    ...
    if (is_laptop)
    {
        publisher = "192.168.70.187";
        broker = "192.168.70.97";
        subscriber = "192.168.70.112";
    }
    else
    {
        publisher = "192.168.70.187";
        broker = "192.168.70.208";
        subscriber = "192.168.70.97";
    }
    vector<int> temp(2);
    set<int> buffer;
    // cout << data[5][5];
            ...
            for (int buffer_element : buffer)
            {
                ...
                if (first_occurence[buffer_element] && ack_no_expecting[buffer_element] <= stoi(data[i][5]) && ack_no_expecting[buffer_element])
                {
                    ...
                    else
                    {
                        ...
                        // temp.push_back(to_string(stod(data[i][0]))); //-1 aayega ki nahi
